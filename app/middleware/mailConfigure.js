...
<body style="margin:0;padding:0;word-spacing:normal;background-color:#108EE9;">
  <div role="article" aria-roledescription="email" lang="en" style="text-size-adjust:100%;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#108EE9;">
        ...
        <td align="center" style="padding:0;">
          ...
          <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
            ...
            <td style="padding:10px;background-color:#ffffff;">
              <h4 style="margin-top:0;margin-bottom:6px;font-size:20px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;">Welcome to the Haga JEK.</h4>
            </td>
          </tr>
            <tr>
              <td style="padding:35px 30px 11px 30px;font-size:0;background-color:#ffffff;border-bottom:1px solid #f0f0f5;border-color:rgba(201,201,207,.35);">
                ...
                <div class="col-lge" style="display:inline-block;width:100%;max-width:395px;vertical-align:top;padding-bottom:20px;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                  <p style="margin-top:0;margin-bottom:12px;">You are officially In ✔</p>
                  <p style="margin-top:0;margin-bottom:18px;">Please enter the sign up OTP to get started</p>
...
<div
  class="container"
  style="max-width: 90%; margin: auto; padding-top: 20px;padding-left: 20px;border:2px solid black"
  >
  <img src="https://blog.sekolahdesain.id/wp-content/uploads/2022/12/moritz-mentges-5MlBMYDsGBY-unsplash-scaled.jpg" alt="Girl in a jacket" width="100" height="100">
  <h2>Welcome to the Haga JEK.</h2>
...
sendEmailOTP = async (otp, emailSend) => {
  const info = await transporter.sendMail({
    from: 'ikhlasul0507@gmail.com', // sender address
    to: emailSend, // list of receivers
    subject: "Verify new account!", // Subject line
    text: "Hello world?", // plain text body
    html: tempHTML(otp), // html body
  });
  return info;
}
module.exports = {
